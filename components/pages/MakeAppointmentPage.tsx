    ...
    <section className="bg-gray-900 text-white py-16 px-4">
      <div className="max-w-7xl mx-auto text-center">
        <div className="flex justify-center mb-6">
          <img src="/path-to-icon/guarantee-icon.png" alt="Guarantee Icon" className="w-24 h-24" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            <div className="flex justify-center mb-4">
              <img src="/path-to-icon/book-online-icon.png" alt="Book Online Icon" className="w-12 h-12" />
            </div>
          ...
          <div className="text-center">
            <div className="flex justify-center mb-4">
              <img src="/path-to-icon/identify-problem-icon.png" alt="Identify Problem Icon" className="w-12 h-12" />
            </div>
          ...
          <div className="text-center">
            <div className="flex justify-center mb-4">
              <img src="/path-to-icon/professional-arrives-icon.png" alt="Professional Arrives Icon" className="w-12 h-12" />
            </div>
          ...
          <div className="text-center">
            <div className="flex justify-center mb-4">
              <img src="/path-to-icon/solve-problem-icon.png" alt="Solve Problem Icon" className="w-12 h-12" />
            </div>
